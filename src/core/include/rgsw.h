...
namespace core::server {
    ...
    /**
     * @brief Takes an RLWE encryption with l coefficients b[i] and converts it to l RLWE encryptions c[i] = RLWE(b[i]) 
     * 
    ...
    inline std::vector<Ciphertext<T>> HoistedExpandRLWE(
        ...
        for(uint32_t i = 1; i < n; i++) {
            ...
            // But it does not work without this line [openfhe-development/src/pke/lib/cryptocontext.cpp:l.558:Decrypt(): ciphertext is empty]
